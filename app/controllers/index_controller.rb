...
#
#    routes <<
#      ["Strathfield NSW Australia NSW Australia",
...
#Picton
    ...
    routes.each do |route|
      ...
      add_waypoints_to_map @map, stops, :none
  ...
  def get_stops_from_route route
    stops = []
    route.each do |stop|
      if @all_stops[stop.to_s].nil?
        @all_stops[stop.to_s] = GoogleGeocoder.geocode(stop.to_s)
      end
